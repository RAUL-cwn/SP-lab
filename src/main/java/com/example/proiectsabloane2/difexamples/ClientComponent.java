package com.example.proiectsabloane2.difexamples;
...
public class ClientComponent {
    ...
    public String toString() {
        // Ca să arate frumos în controller
        return "ClientComponent@" + Integer.toHexString(System.identityHashCode(this));
    }
}
